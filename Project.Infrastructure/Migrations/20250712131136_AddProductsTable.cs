        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitsInStock = table.Column<byte>(type: "tinyint", nullable: true, defaultValue: (byte)0),
                    UnitsOnOrder = table.Column<byte>(type: "tinyint", nullable: true, defaultValue: (byte)0),
                    ReorderLevel = table.Column<byte>(type: "tinyint", nullable: true, defaultValue: (byte)0),
